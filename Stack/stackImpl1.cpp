...
class Stack{
    public:
          int* arr;//intilisation of dynamic array
          int size;
          int top;

          Stack(int capacity) {
            arr = new int[capacity];//assign size to dynamically created array
            size = capacity;
            top = -1;
          }
...
int main() {
  ...
  Stack s(5);//object created to constructor and assign value of capacity equal to 5;
  s.print();
  s.push(10);
  s.print();
  s.push(20);
